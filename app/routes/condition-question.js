...
router.post('/v12/condition-questions/option-five/undiagnosed-condition', function(req, res) {
  ...
  const queriesCondition  = req.session.data.queriesCondition2 || []
  queriesCondition .push({ condition, startDate, diagnosed, symptoms, testResults })
  req.session.data.queriesCondition2  = queriesCondition
...
router.post('/v12/condition-questions/option-five/remove-condition-confirmation', (req, res, next) => {
        res.redirect('/v12/condition-questions/option-five/check-answers-condition');
});
...
router.post('/v12/condition-questions/option-five/remove-medication-confirmation', (req, res, next) => {
        res.redirect('/v12/condition-questions/option-five/check-answers');
});
...
router.post('/v12/condition-questions/option-five/remove-treatment-confirmation', (req, res, next) => {
        res.redirect('/v12/condition-questions/option-five/treatment-check-answers');
});
...
router.post('/v12/condition-questions/option-six/undiagnosed-condition', function(req, res) {
    if (req.session.data['undiagnosed-condition'] == "Yes") {
               ...
               res.redirect('list-1?aboutyourhealth=completed')
             }
})
...
router.post('/v12/condition-questions/option-five/further-treatments', function(req, res) {
    if (req.session.data['further-treatments'] == "Yes") {
               ...
               res.redirect('/v12/condition-questions/option-five/medication-treatment-summary')
             }
})
